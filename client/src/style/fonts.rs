...
/// * `srcs` - Source urls
///
pub fn create_font(family: &str, local: &str, style: Style, weight: Weight, srcs: &[&str]) -> css::Style {
...
pub fn fonts() -> css::Style {
	create_font("Alfa Slab One", "Alfa-Slab-One", Style::Normal, Weight::Normal, &["https://fonts.gstatic.com/s/alfaslabone/v10/6NUQ8FmMKwSEKjnm5-4v-4Jh2dJhew.woff2"])
	+ create_font("Degrassi", "Degrassi Regular", Style::Normal, Weight::Normal, &["../public/fonts/degrassi/degrassi.ttf"])
	+ create_font("Space Mono", "Space Mono Regular", Style::Normal, Weight::Number(400), &[
	...
	+ create_font("Space Mono", "Space Mono Bold", Style::Normal, Weight::Number(700), &[
